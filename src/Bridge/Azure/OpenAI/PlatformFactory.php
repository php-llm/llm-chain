...
final readonly class PlatformFactory
{
    public static function create(
        ...
        $embeddingsResponseFactory = new EmbeddingsResponseFactory($httpClient, $baseUrl, $deployment, $apiVersion, $apiKey);
        $GPTResponseFactory = new GPTResponseFactory($httpClient, $baseUrl, $deployment, $apiVersion, $apiKey);
